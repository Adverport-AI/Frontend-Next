...
// Brand logo imports
import imgBeymenLogo from "figma:asset/475353305f5614af0afb11ccf4b79302062766a8.png";
import imgAddaxLogo from "figma:asset/9e42cf66091a458eba6553e70ae200fd5a337f46.png";
...
// Styled text logos for example brands — replace all with real logo images
const brands: Brand[] = [
...
// Consistent gradient per brand
function BrandLogo({ brand, size = 'lg' }: { brand: Brand; size?: 'sm' | 'lg' }) {
  const imgSizeClasses = size === 'sm' ? 'max-h-6 sm:max-h-8 max-w-[60px] sm:max-w-[80px]' : 'max-h-12 sm:max-h-16 max-w-[140px] sm:max-w-[200px]';
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start justify-between gap-3 mb-2">
          <h3 className="font-['Inter',sans-serif] text-white text-lg sm:text-xl font-bold">
            {brand.name}
          </h3>
    ...
    <main>
      ...
      <section className="bg-[#0a0a0a] py-16 sm:py-20 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8">
          ...
          {/* Results count */}
          <p className="font-['Inter',sans-serif] text-white/40 text-sm mb-6">
          ...
          {filteredBrands.length === 0 && (
            <div className="text-center py-20">
              ...
              <p className="font-['Inter',sans-serif] text-white/40 text-lg">
      ...
      <section className="bg-[#0a0a0a] py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-[#d21027] to-[#EB5200] text-white px-8 py-4 rounded-full font-bold text-base hover:shadow-[0_0_30px_rgba(210,16,39,0.5)] transition-all font-['Inter',sans-serif]">
              Ücretsiz Başla
            </button>
            <button className="bg-white/10 border border-white/20 text-white px-8 py-4 rounded-full font-bold text-base hover:bg-white/20 transition-all font-['Inter',sans-serif]">
