...
const faqItems = [
  { q: 'Hesabımı nasıl silebilirim?', a: 'Ayarlar > Hesap bölümünden hesap silme talebinde bulunabilirsiniz. Talebiniz 7 iş günü içinde işleme alınır.' },
  { q: 'Ödemem gecikti, ne yapmalıyım?', a: 'Ödeme gecikmeleri nadiren yaşanır. destek@adverport.com adresine yazarak detaylı bilgi alabilirsiniz.' },
  { q: 'Marka başvurusu nasıl yapabilirim?', a: 'Marka olarak platforma katılmak için İş Ortaklığı formunu doldurmanız yeterlidir. Ekibimiz 48 saat içinde size dönüş yapar.' },
  { q: 'Premium üyeliği nasıl iptal ederim?', a: 'Ayarlar > Abonelik bölümünden Premium üyeliğinizi istediğiniz zaman iptal edebilirsiniz.' },
];
  ...
  return (
    <main>
      ...
      <section className="relative bg-black pt-[140px] sm:pt-[160px] pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#EB5200] opacity-8 blur-[150px] rounded-full" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="font-['Inter',sans-serif] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-5">
              Bize{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EB5200] to-[#FFBA6F]">Ulaşın</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-3">
              <h2 className="font-['Inter',sans-serif] text-2xl sm:text-3xl font-bold text-white mb-2">
                Mesaj <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EB5200] to-[#FFBA6F]">Gönderin</span>
              </h2>
              <p className="font-['Inter',sans-serif] text-white/50 text-sm mb-8">Formu doldurun, en kısa sürede size dönüş yapalım.</p>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="font-['Inter',sans-serif] text-white/60 text-sm mb-6">En kısa sürede size dönüş yapacağız.</p>
                  <button
                    onClick={() => {
                      setSubmitted(false);
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gradient-to-b from-white/[0.07] to-white/[0.02] border border-white/10 rounded-2xl p-6 sm:p-8">
                ...
                <p className="font-['Inter',sans-serif] text-white/50 text-sm mb-4">Markanızı platformumuza eklemek mi istiyorsunuz?</p>
                <a href="#" className="inline-flex items-center gap-1.5 text-[#EB5200] hover:text-[#FFBA6F] text-sm font-medium transition-colors font-['Inter',sans-serif]">
        ...
        <div className="relative max-w-3xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            <h2 className="font-['Inter',sans-serif] text-2xl sm:text-3xl font-bold text-white mb-3">
              Hızlı <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EB5200] to-[#FFBA6F]">Yanıtlar</span>
            </h2>
            ...
            {faqItems.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ArrowRight className={`w-5 h-5 text-[#EB5200] flex-shrink-0 transition-transform ${openFaq === index ? 'rotate-90' : ''}`} />
                </button>
                {openFaq === index && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="h-64 lg:h-auto min-h-[300px] bg-gradient-to-br from-[#d21027]/10 to-[#EB5200]/5 flex items-center justify-center relative">
                <div className="absolute inset-0 opacity-20">
                  ...
                  <div className="absolute top-1/3 left-1/2 w-3 h-3 rounded-full bg-[#d21027] animate-pulse" style={{ animationDelay: '0.5s' }} />
                  <div className="absolute top-1/2 left-1/3 w-2 h-2 rounded-full bg-[#FFBA6F] animate-pulse" style={{ animationDelay: '1s' }} />
                  <div className="absolute top-2/3 right-1/3 w-2 h-2 rounded-full bg-[#EB5200] animate-pulse" style={{ animationDelay: '1.5s' }} />
                </div>
