import imgIPhone13 from "figma:asset/36c19dca002fd11ebaa0df8ed37c61afd2a2fef6.png";
import imgScreen1 from "figma:asset/83f733506694c511087cc3dbfe18347154406cc4.png";
import imgChangeThis from "figma:asset/aca5c3fa561b6b57946873f8350684d4efb235bd.png";
  ...
  return (
    <div className="absolute contents inset-[2.01%_2.84%_3.87%_7.74%]" data-name="Mockup">
      ...
      <div className="absolute inset-[1.52%_0.72%_3.32%_5.94%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[10.757px_4.857px] mask-size-[533.818px_930.842px]" data-name="Change-This" style={{ maskImage: `url('${imgScreen}')` }}>
        <img alt="" className="absolute block max-w-none size-full" height="941.136" src={imgChangeThis} width="557.223" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute contents inset-0" data-name="iPhone-13">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgIPhone13} />
      </div>
      <Mockup />
    </div>
  );
